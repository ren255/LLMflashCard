...
class StorageController:
        ...
        for file_type in self.FILETYPE_INFO.keys():
            type_directories.extend(
                [
                    ...
                    self.base_path
                    / "temp"
                    / file_type,  # resources/temp/image, resources/temp/flashcard
                    self.base_path
                    / "thumbnails"
                    / file_type,  # resources/thumbnails/image, resources/thumbnails/flashcard
                ]
            )
            ...
            paths_info.update(
                {
                    ...
                    f"{file_type}_thumbnails_path": str(
                        self.base_path / "thumbnails" / file_type
                    ),
                }
            )
    ...
    def get_storage_stats(self) -> Dict[str, Any]:
        ...
        stats.update({"total_files": total_files, "total_size": total_size})
